...
public class Mp3MetadataDto {
    ...
    /*@Documented
    @Constraint(validatedBy = com.goropai.songservice.entity.dto.Mp3MetadataDto.YearFormatValidator.class)
    ...
    @Component
    public static class YearFormatValidator implements ConstraintValidator<com.goropai.songservice.entity.dto.Mp3MetadataDto.ValidYear, String> {
        @Override
    ...
    @Documented
    @Constraint(validatedBy = com.goropai.songservice.entity.dto.Mp3MetadataDto.DurationFormatValidator.class)
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER })
    @Retention(RetentionPolicy.RUNTIME)
    ...
    @Component
    public static class DurationFormatValidator implements ConstraintValidator<com.goropai.songservice.entity.dto.Mp3MetadataDto.ValidDuration, String> {
        @Override
